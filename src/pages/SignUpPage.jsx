...
import { ArrowRight, CheckCircle, Eye, EyeOff, Rocket } from 'lucide-react';
            ...
            {submittedEmail && (
              <div className="p-6 border-2 border-green-600 bg-green-50">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <span className="text-sm font-black uppercase tracking-widest text-green-700">Check Your Email</span>
                </div>
